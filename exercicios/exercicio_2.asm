...
main: 
	# lw variável, memória -> seta o conteúdo da variavel para o registrador usando o endereço do registrador na memória
	# sw valor, palavra -> armazena valor na palavra
	addi s2, zero, 1	# Inicializa s2 em 1
	la s3, Array_A  	# Como o exercício assume que o endereço-base de A[] está em s3, foi incluida essa instrução
	lw t0, 32(s3)		# t0 = A[8]
	add t0, s2, t0		# t0 = t + h
	sw t0, 48(s3)		# A[12] = t0
