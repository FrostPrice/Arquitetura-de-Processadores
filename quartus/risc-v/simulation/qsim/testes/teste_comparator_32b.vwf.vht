...
-- *****************************************************************************
-- Generated on "06/29/2023 14:20:58"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          comparator_32b
-- 
...
ENTITY comparator_32b_vhd_vec_tst IS
END comparator_32b_vhd_vec_tst;
ARCHITECTURE comparator_32b_arch OF comparator_32b_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL i_A : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL i_B : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL i_C_EQUAL : STD_LOGIC;
SIGNAL i_C_GREATER_THAN : STD_LOGIC;
SIGNAL i_C_LESS_THAN : STD_LOGIC;
SIGNAL o_EQUAL : STD_LOGIC;
SIGNAL o_GREATER_THAN : STD_LOGIC;
SIGNAL o_LESS_THAN : STD_LOGIC;
COMPONENT comparator_32b
	PORT (
	i_A : IN STD_LOGIC_VECTOR(31 DOWNTO 0);
	i_B : IN STD_LOGIC_VECTOR(31 DOWNTO 0);
	i_C_EQUAL : IN STD_LOGIC;
	i_C_GREATER_THAN : IN STD_LOGIC;
	i_C_LESS_THAN : IN STD_LOGIC;
...
-- list connections between master ports and signals
	...
	i_B => i_B,
	i_C_EQUAL => i_C_EQUAL,
	i_C_GREATER_THAN => i_C_GREATER_THAN,
	i_C_LESS_THAN => i_C_LESS_THAN,
	o_EQUAL => o_EQUAL,
	o_GREATER_THAN => o_GREATER_THAN,
...
-- i_C_LESS_THAN
t_prcs_i_C_LESS_THAN: PROCESS
BEGIN
	i_C_LESS_THAN <= '0';
WAIT;
END PROCESS t_prcs_i_C_LESS_THAN;

-- i_C_EQUAL
t_prcs_i_C_EQUAL: PROCESS
BEGIN
	i_C_EQUAL <= '1';
WAIT;
END PROCESS t_prcs_i_C_EQUAL;

-- i_C_GREATER_THAN
t_prcs_i_C_GREATER_THAN: PROCESS
BEGIN
	i_C_GREATER_THAN <= '0';
WAIT;
END PROCESS t_prcs_i_C_GREATER_THAN;
END comparator_32b_arch;
